      ...
      <div className="max-w-7xl 2xl:max-w-screen-2xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-8">
        <section className="flex flex-col md:gap-10 gap-4">
          ...
          <p className="font-base text-highlightSecondary text-sm md:text-2xl">
            Feedback is invaluable to me and i hope to improve the experience of
            using this application while development is ongoing, i'd love to
            hear your thoughts on the site and if and how its been helping you
            out.
          </p>
          <p className="font-base text-highlightSecondary text-sm md:text-2xl">
            if you have any suggesstions regarding what i should implement next
            feel free to drop them as well, you can also use this to request
            assignments or request to contribute to the site, i would greatly
