        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="w-full flex items-center justify-center">
            <div className="w-full max-w-xs md:max-w-sm">
              <img
                src="https://res.cloudinary.com/drtyjus1u/image/upload/v1740310092/about_giozfg.png"
                alt=""
      ...
      <div className="flex justify-center items-center max-w-7xl 2xl:max-w-screen-2xl mx-auto w-full">
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="w-full flex items-center justify-center order-last md:order-first">
            <div className="w-full max-w-xs md:max-w-sm">
              <img
                src="https://res.cloudinary.com/drtyjus1u/image/upload/v1740310095/about-2_g7zxmo.jpg"
                alt=""
