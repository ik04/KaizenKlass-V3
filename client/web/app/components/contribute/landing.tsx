...
export const Landing = () => {
  return (
    <div className="bg-[url('https://res.cloudinary.com/drtyjus1u/image/upload/v1740310108/bg-contribute_fksiln.webp')] bg-cover bg-center bg-no-repeat h-screen flex justify-center items-center">
